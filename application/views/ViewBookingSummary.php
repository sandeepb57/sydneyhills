							...
							<div id="booking-summary">
								...
								<?php if ($status == 200) {?>
									...
									<div class="col-xs-6  col-sm-6  col-md-6  ">
										<a class="btn btn-primary btn-block" href="<?php echo base_url(); ?>BookHorses/PayNow?bookingId=<?php echo $this->encryption->encrypt($result[0]["bookingId"]); ?>">Go to my bookings</a>
									</div>
									<div class="col-xs-6  col-sm-6  col-md-6 ">
										<a class="btn btn-success btn-block" href="<?php echo base_url(); ?>BookHorses/PayNow?bookingId=<?php echo $this->encryption->encrypt($result[0]["bookingId"]); ?>">Pay now</a>
									</div>
									</div>
									</div>
								<?php }?>
